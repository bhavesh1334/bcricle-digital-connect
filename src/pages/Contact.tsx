      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Contact Form */}
            <div className="bg-white p-8 rounded-lg border border-border shadow-sm h-max">
              <h2 className="font-montserrat font-bold text-2xl mb-6 text-bcircle-blue">
                Send Us a Message
              </h2>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto bg-green-50 p-8 rounded-lg border border-green-200">
            ...
            >
              <a href="https://wa.me/918719899808?text=Hello%CBN%2C%20I%20need%20assistance%20with%20" target="_blank" rel="noopener noreferrer">
