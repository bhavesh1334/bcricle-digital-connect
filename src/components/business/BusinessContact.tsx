...
const BusinessContact: React.FC<BusinessContactProps> = ({ business }) => {
  ...
  return (
    <div className="bg-white rounded-lg p-6 shadow-md">
      <h2 className="text-2xl font-montserrat font-semibold text-gray-800 mb-6">Contact Information</h2>
      ...
      <div className="space-y-6">
        <div className="bg-gray-50 p-5 rounded-lg border border-gray-100">
          ...
          <p className="text-gray-700 ml-7 mb-2">{fullAddress}</p>
          <a 
            href={googleMapsUrl} 
            target="_blank" 
            rel="noopener noreferrer"
            className="ml-7 text-bcircle-blue hover:underline font-medium text-sm inline-flex items-center"
          >
            View on Google Maps
        ...
        <div className="pt-4 space-y-3">
          <Button className="w-full bg-bcircle-blue hover:bg-bcircle-blue/90 text-white shadow-md py-6">
            <Phone className="h-4 w-4 mr-2" /> 
            Call Now
          </Button>
          
          <Button className="w-full bg-green-500 hover:bg-green-600 text-white shadow-md py-6">
          ...
          <Button variant="outline" className="w-full border-2 border-bcircle-blue text-bcircle-blue hover:bg-bcircle-blue hover:text-white shadow-md py-6 transition-colors">
